...
Store performance varies significantly, with some locations overperforming and others consistently underperforming.
Product category profitability is unclear, limiting effective pricing, stocking, and promotional decisions.
...
Removed duplicates and corrected data quality issues
Standardised store and customer location fields
Joined the sales, customers, stores, and products tables
Created a master analytical dataset for reporting
2. Exploratory Data Analysis
Customer segmentation based on demographics and loyalty
Store performance benchmarking
Product category revenue and quantity analysis
Monthly/seasonal trends
Basket size analysis
Price sensitivity and spend behaviour
3. Data Visualisation
Power BI executive dashboard for revenue, store performance, and customer insights
Tableau exploratory dashboard for category drilldowns, heatmaps, and forecasting
Excel pivot tables, KPI summary, and trend charts
4. Insight Development
Synthesised findings from dashboards and SQL outputs
...
Tableau (interactive analytics and forecasting)
Excel (pivot tables, KPIs, trend lines)
Analysis Techniques
...
Customer, store, and product recommendations
